...
import { OMNIDEF } from './dispositionForRetailMainEnglish_def.js';
import tmpl from './dispositionForRetailMainEnglish.html';
import tmpl_nds from './dispositionForRetailMainEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dispositionForRetailMainEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
