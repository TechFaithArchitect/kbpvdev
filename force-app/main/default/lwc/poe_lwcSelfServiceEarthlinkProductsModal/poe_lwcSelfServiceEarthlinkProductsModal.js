...
import SERVER_ERROR_TOAST_TILE from "@salesforce/label/c.Server_Error_Toast_Title";
...
import WIRED_PRODUCT_SELECTION_MODAL_INSTRUCTIONS from "@salesforce/label/c.Earthlink_Wired_Product_Selection_Modal_Instructions";

const INTERNAL_ERROR = "Internal Error";
const API_ERROR = "API Error";
const PRODUCT_CONTENT_CLASS = "price-content";

export default class Poe_lwcSelfServiceEarthlinkProductsModal extends LightningModal {
    ...
    labels = {
        ...
        WIRED_PRODUCT_SELECTION_MODAL_INSTRUCTIONS
    }
