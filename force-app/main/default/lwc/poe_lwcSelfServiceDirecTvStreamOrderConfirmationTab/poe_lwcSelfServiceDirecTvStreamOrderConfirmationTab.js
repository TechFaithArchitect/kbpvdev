...
export default class Poe_lwcSelfServiceDirecTvStreamOrderConfirmationTab extends LightningElement {
    @api orderInfo;
    @api origin;
    @api cartInfo;
    @api recordId;
    ...
    get orderFailed() {
        return !this.orderSuccess && !this.orderInProgress && !this.loaderSpinner;
    }

    get refreshButtonLabel() {
        return !this.orderInProgress && !this.orderSuccess && !this.loaderSpinner ? "Resend Order" : "Refresh";
    }
    ...
    get orderNumber() {
        return this.cartInfo?.orderNumber || this.orderInfo?.stream?.orderNumber;
    }
    ...
    showModalSendingOrder(checkOrderCallout) {
        poe_lwcSelfServiceLoadingModal
            ...
            .then((result) => {
                ...
                if (result.getOrderResultInfoInput) {
                    this.getOrderResultInfo(result.getOrderResultInfoInput);
                }
            });
    }
