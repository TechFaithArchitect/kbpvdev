...
import { OMNIDEF } from './buyflowPCICreditCheckPublicFormEnglish_def.js';
import tmpl from './buyflowPCICreditCheckPublicFormEnglish.html';
import tmpl_nds from './buyflowPCICreditCheckPublicFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class buyflowPCICreditCheckPublicFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
