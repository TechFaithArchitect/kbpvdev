...
import { OMNIDEF } from './homepageCreateCaseEnglish_def.js';
import tmpl from './homepageCreateCaseEnglish.html';
import tmpl_nds from './homepageCreateCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homepageCreateCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
