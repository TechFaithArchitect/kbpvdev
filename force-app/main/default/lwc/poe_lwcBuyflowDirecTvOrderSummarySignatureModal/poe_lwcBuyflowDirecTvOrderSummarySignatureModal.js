...
export default class Poe_lwcBuyflowDirecTvOrderSummarySignatureModal extends LightningElement {
    @api recordId;
    @api program;
    @api name;
    @api address;
    ...
    connectedCallback() {
        ...
        const params = {
            ...
            sMethodName: "Buyflow_getSignatureFile",
    ...
    handleClearClick() {
        ...
        ctx.clearRect(0, 0, canvasElement.width, canvasElement.height);
        ctx.drawImage(background, 0, 0);
        this.drawText("Date: " + stringToday, canvasElement.width / 3 - 75, canvasElement.height - 10, 11, "verdana");
        this.drawText("Customer: " + this.name, canvasElement.width / 3 - 75, canvasElement.height - 20, 11, "verdana");
        this.drawText(
            "Address: " + this.address,
            canvasElement.width / 3 - 75,
            canvasElement.height - 30,
