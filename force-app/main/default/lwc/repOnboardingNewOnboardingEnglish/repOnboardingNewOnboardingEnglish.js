...
import { OMNIDEF } from './repOnboardingNewOnboardingEnglish_def.js';
import tmpl from './repOnboardingNewOnboardingEnglish.html';
import tmpl_nds from './repOnboardingNewOnboardingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class repOnboardingNewOnboardingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
