...
import selfServiceConfigurationsTabTitle from "@salesforce/label/c.Frontier_Configurations_Tab_Title";
import selfServiceConfigurationsTabSubTitle from "@salesforce/label/c.Frontier_Configurations_Sub_Title";
import selfServiceConfigurationsRouterTitle from "@salesforce/label/c.Frontier_Configurations_Router_Title";
import posIdMessage from "@salesforce/label/c.Frontier_POS_ID_Modal_Message";
import modal from "c/poe_lwcSelfServiceFrontierConfigurationsModal";
...
export default class Poe_lwcSelfServiceFrontierConfigurationsTab extends LightningElement {
    @api productInfo;
    @api recordId;
    @api logo;
    @api addressInfo;
    ...
    labels = {
        ...
        posIdMessage,
        selfServiceConfigurationsTabTitle,
        selfServiceConfigurationsTabSubTitle,
        selfServiceConfigurationsRouterTitle,
        EERO_ID,
        EERO_DISCOUNT_ID,
        SECURITY_PLUS_ID
    };
    ...
    get iconFormExtra() {
        return chuzoSiteResources + "/images/icon-frontier-extra-services.svg";
    }
    ...
    handleRouterConfiguration(minQ) {
        ...
        if (minQ <= routersMandatory.length) {
            ...
            this.routerOption = noConfig.value;
        }
    ...
    handleRouter(event) {
        ...
        this.cart = { ...cart };
        let cartupdateEvent = new CustomEvent("cartupdate", { detail: this.cart });
    ...
    generateInitialCart(summaryItems) {
        ...
        this.voipOption = this.voipWanted ? true : false;
        this.cart = { ...cart };
        let cartupdateEvent = new CustomEvent("cartupdate", { detail: this.cart });
        this.dispatchEvent(cartupdateEvent);
    ...
    handleVoip(event) {
        let ids = [];
        this.voipOption = event.target.checked;
        this.voipWanted = event.target.checked;
        let voiceProduct = [...JSON.parse(JSON.stringify(this.voiceProducts))];
        let cart = { ...this.cart };
        if (!this.voipWanted) {
                        ...
                        if (
                            ...
                            modal
                                .open({
                                    ...
                                    disableClose: true,
                                    hasPhone: this.voipWanted,
                                    freezeOption: this.localFreezeOption,
                                    internationalOptions: this.internationalConfigurations,
                                    freezeOptions: this.localFreezeOptions,
                                    additionalListing: this.additionalListing,
                                    listingOptions: this.listingOptions,
                                    homeOption: this.homeAddon,
                                    listingOption: this.listingOption,
                                    listedId: this.listedId,
                                    voiceMailOption: this.voiceMailConfiguration,
                                    onconfirm: (event) => {
                                        event.stopPropagation();
                                        this.handleConfirmModal(event);
                                    },
                                    onlistingselected: (event) => {
                                        event.stopPropagation();
                                        this.handleListingSelection(event);
                                    },
                                    onadditionalselected: (event) => {
                                        event.stopPropagation();
                                        this.handleAdditionalListingSelection(event);
                                    },
                                    oninternationalselected: (event) => {
                                        event.stopPropagation();
                                        this.handleInternationalSelection(event);
                                    },
                                    onmailselected: (event) => {
                                        event.stopPropagation();
                                        this.handleMailSelected(event);
                                    },
                                    onringselected: (event) => {
                                        event.stopPropagation();
                                        this.handleRingSelected(event);
                                    },
                                    onhomeselected: (event) => {
                                        event.stopPropagation();
                                        this.handleHomeAddon(event);
                                    },
                                    onfreezeselected: (event) => {
                                        event.stopPropagation();
                                        this.handleHomeAddon(event);
                                    }
                                })
    ...
    async openModal() {
        //const result = await
        //result.then((response)=>console.log(response)).catch((item) => console.error(item));
    }
    ...
    logError(errorMessage, request, endpoint = "", type = "Internal Error") {
        const error = {
            ...
            type,
            tab: "Configurations",
            component: "poe_lwcSelfServiceFrontierConfigurationsTab",
            error: errorMessage
        };
