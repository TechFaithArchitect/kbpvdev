...
import URL_Viasat from  "@salesforce/label/c.URL_Viasat";
...
export default class Poe_lwcBuyflowViasatSBSButton extends LightningElement {
    @api recordId;
    @api isGuestUser;
    loaderSpinner;
    ongoingTouches = [];
        ...
        getSBSFile({ myData: myData })
            .then((response) => {
                ...
                if (this.isUpdate) {
                    ...
                    newBack.src = this.labels.URL_Viasat + response.result.Id;
