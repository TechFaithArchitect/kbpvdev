...
export default class ClickerPhoneSales extends NavigationMixin(LightningElement) {
    ...
    logError(errorMessage, request, endpoint = "", type = "Internal Error") {
        const error = {
            ...
            endpoint,
            type,
            tab: "Clicker Phone Sales",
            component: "clickerPhoneSales",
