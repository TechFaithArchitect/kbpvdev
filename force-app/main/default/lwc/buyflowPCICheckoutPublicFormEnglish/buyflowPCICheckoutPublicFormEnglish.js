...
import { OMNIDEF } from './buyflowPCICheckoutPublicFormEnglish_def.js';
import tmpl from './buyflowPCICheckoutPublicFormEnglish.html';
import tmpl_nds from './buyflowPCICheckoutPublicFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class buyflowPCICheckoutPublicFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
