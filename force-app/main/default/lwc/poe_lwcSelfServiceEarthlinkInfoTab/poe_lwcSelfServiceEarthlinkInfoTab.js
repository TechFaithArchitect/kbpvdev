...
import ADDRESS_INFORMATION_TITLE from "@salesforce/label/c.Address_Information_Title";
import SERVICE_ADDRESS_INFORMATION_TITLE from "@salesforce/label/c.Service_Address_Title";
import SERVICE_ADDRESS_INFORMATION_SUBTITLE from "@salesforce/label/c.Service_Address_Subtitle";
...
export default class poe_lwcSelfServiceEarthlinkInfoTab extends NavigationMixin(LightningElement) {
    @api recordId;
    @api logo;
    @api isGuestUser;
    ...
    labels = {
        ...
        SERVICE_ADDRESS_INFORMATION_TITLE,
        SERVICE_ADDRESS_INFORMATION_SUBTITLE,
