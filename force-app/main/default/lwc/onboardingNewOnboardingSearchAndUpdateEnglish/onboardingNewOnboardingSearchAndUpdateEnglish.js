...
import { OMNIDEF } from './onboardingNewOnboardingSearchAndUpdateEnglish_def.js';
import tmpl from './onboardingNewOnboardingSearchAndUpdateEnglish.html';
import tmpl_nds from './onboardingNewOnboardingSearchAndUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class onboardingNewOnboardingSearchAndUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
