...
import { OMNIDEF } from './onboardingNewOnboardingCreateEnglish_def.js';
import tmpl from './onboardingNewOnboardingCreateEnglish.html';
import tmpl_nds from './onboardingNewOnboardingCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class onboardingNewOnboardingCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
