...
export default class Poe_lwcBuyflowFrontierConfigurationsModal extends LightningElement {
    @api hasPhone;
    @api freezeOptions;
    @api freezeOption;
    ...
    disableValidations() {
        if (
            ...
            ((this.voiceMailSelected && this.ring !== undefined) || !this.voiceMailSelected)
        ) {
            this.noInfo = false;
        } else {
            this.noInfo = true;
