...
import SBS_SAVE_IMAGE_ERROR_MESSAGE from "@salesforce/label/c.SBS_Save_Image_Error_Message";
import CANCEL_BUTTON_LABEL from "@salesforce/label/c.Cancel_Button_Label";
import CLEAN_BUTTON_LABEL from "@salesforce/label/c.Clean_Button_Label";
...
export default class Poe_lwcBuyflowEarthlinkSBSButton extends LightningElement {
    @api recordId;
    loaderSpinner;
    ongoingTouches = [];
    isDrawing = false;
    ...
    handleSaveClick() {
        ...
        saveSBSFile({ myData: myData })
            ...
            .catch((error) => {
                ...
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: SBS_SAVE_IMAGE_ERROR_MESSAGE,
