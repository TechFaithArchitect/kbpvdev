...
import { OMNIDEF } from './buyflowAddressServiceabilityCheckEnglish_def.js';
import tmpl from './buyflowAddressServiceabilityCheckEnglish.html';
import tmpl_nds from './buyflowAddressServiceabilityCheckEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class buyflowAddressServiceabilityCheckEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
