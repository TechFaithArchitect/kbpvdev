...
export function ProtectPANandCVVProd(t, o, k, PIE) {
    var l = SDW.distill(t);
    var r = SDW.distill(o);
...
export function ValidatePANChecksumProd(b) {
    var a = SDW.distill(b);
    return a.length >= 13 && a.length <= 19 && SDW.luhn(a) == 0;
}
export function ProtectString(g, h) {
...
sjcl.cipher.aes.prototype = {
    ...
    _crypt: function (k, n) {
        ...
        for (p = 0; p < 4; p++) {
            q[n ? 3 & -p : p] =
                (l[v >>> 24] << 24) ^ (l[(u >> 16) & 255] << 16) ^ (l[(t >> 8) & 255] << 8) ^ l[s & 255] ^ y[o++];
            w = v;
            v = u;
            u = t;
            t = s;
    ...
    encode: function (b) {
        ...
        while (a < b.length) {
            ...
            if (e < 128) {
                ...
                if (e >= 2048) {
                    d +=
                        String.fromCharCode((e >> 12) | 224) +
                        String.fromCharCode(((e >> 6) & 63) | 128) +
                        String.fromCharCode((e & 63) | 128);
                } else {
...
FFX.cbcmacq = function (e, f, b, a) {
    ...
    while (4 * g < b) {
        for (var c = 0; c < d; ++c) {
            h[c] =
                h[c] ^
                ((f[4 * (g + c)] << 24) | (f[4 * (g + c) + 1] << 16) | (f[4 * (g + c) + 2] << 8) | f[4 * (g + c) + 3]);
        }
        h = a.encrypt(h);
        g = g + d;
    }
