...
import { OMNIDEF } from './onboardingNewOnboardingEnglish_def.js';
import tmpl from './onboardingNewOnboardingEnglish.html';
import tmpl_nds from './onboardingNewOnboardingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class onboardingNewOnboardingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
