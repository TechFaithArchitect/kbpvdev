...
export default class Poe_lwcBuyflowDirecTvEngaInfoTab extends NavigationMixin(LightningElement) {
    @api recordId;
    @api logo;
    @api origin;
    @api clientInfo;
    ...
    hideDealerCodeStatusModal() {
        this.showDealerCodeStatusModal = false;
    }
}