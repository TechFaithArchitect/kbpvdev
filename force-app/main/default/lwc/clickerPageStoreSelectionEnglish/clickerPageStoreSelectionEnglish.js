...
import { OMNIDEF } from './clickerPageStoreSelectionEnglish_def.js';
import tmpl from './clickerPageStoreSelectionEnglish.html';
import tmpl_nds from './clickerPageStoreSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clickerPageStoreSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
