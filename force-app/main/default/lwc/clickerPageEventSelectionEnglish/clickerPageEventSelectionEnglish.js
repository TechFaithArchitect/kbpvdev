...
import { OMNIDEF } from './clickerPageEventSelectionEnglish_def.js';
import tmpl from './clickerPageEventSelectionEnglish.html';
import tmpl_nds from './clickerPageEventSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clickerPageEventSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
